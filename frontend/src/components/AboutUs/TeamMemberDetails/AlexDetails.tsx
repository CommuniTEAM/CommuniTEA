...
import AlexCropped from '../../../assets/AlexCropped.jpg';
import Github from '../../../assets/GitHubBlack.png';
import LinkedIn from '../../../assets/LinkedIn.png';

export default function AlexDetails(): JSX.Element {
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ flexGrow: 1, maxWidth: '100vw', width: '50%' }}>
        <img src={AlexCropped} alt="Alex" style={{ maxWidth: '100%' }} />
      </div>
        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <a
                href="https://www.linkedin.com/in/alexyho9/"
                target="_blank"
              ...
              <a
                href="https://github.com/alexyho9"
                target="_blank"
                rel="noreferrer noopener"
              >
