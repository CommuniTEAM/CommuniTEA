...
import HectorCropped from '../../../assets/HectorCropped.jpg';
import Github from '../../../assets/GitHubBlack.png';
import LinkedIn from '../../../assets/LinkedIn.png';

export default function HectorDetails(): JSX.Element {
  ...
  return (
    <div style={{ display: 'flex' }}>
      ...
      <div style={{ flexGrow: 1, maxWidth: '100vw', width: '50%' }}>
        <img src={HectorCropped} alt="Hector" style={{ maxWidth: '100%' }} />
      </div>
        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <a
                href="https://www.linkedin.com/in/hector-elias-i444/"
                target="_blank"
              ...
              <a
                href="https://github.com/helias-444"
                target="_blank"
                rel="noreferrer noopener"
              >
